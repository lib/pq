...
// array syntax.
//
// T may optionally implement the "ArrayDelimiter() string" method to use a
// different array delimiter.
//
// XXX: document array element conversion:
//
// [sql.ConvertAssign]
//
// T can be any primitive type (string, int, etc.). The Scan() method is called
// for every array element if T implements [sql.Scanner].
