...
var timeTests = []struct {
	...
	{"0010-02-03 04:05:06.123-07 BC", time.Date(-10, time.February, 3, 4, 5, 6, 123000000,
		time.FixedZone("", -7*60*60))},
	{"04:05:06", time.Date(1, time.January, 1, 4, 5, 6, 0, time.UTC)},
	{"04:05:06.000001", time.Date(1, time.January, 1, 4, 5, 6, 1000, time.UTC)},
	{"04:05:06.00001", time.Date(1, time.January, 1, 4, 5, 6, 10000, time.UTC)},
	{"04:05:06.0001", time.Date(1, time.January, 1, 4, 5, 6, 100000, time.UTC)},
	{"04:05:06.001", time.Date(1, time.January, 1, 4, 5, 6, 1000000, time.UTC)},
	{"04:05:06.01", time.Date(1, time.January, 1, 4, 5, 6, 10000000, time.UTC)},
	{"04:05:06.1", time.Date(1, time.January, 1, 4, 5, 6, 100000000, time.UTC)},
	{"04:05:06.12", time.Date(1, time.January, 1, 4, 5, 6, 120000000, time.UTC)},
	{"04:05:06.123", time.Date(1, time.January, 1, 4, 5, 6, 123000000, time.UTC)},
	{"04:05:06.1234", time.Date(1, time.January, 1, 4, 5, 6, 123400000, time.UTC)},
	{"04:05:06.12345", time.Date(1, time.January, 1, 4, 5, 6, 123450000, time.UTC)},
	{"04:05:06.123456", time.Date(1, time.January, 1, 4, 5, 6, 123456000, time.UTC)},
	{"04:05:06.123-07", time.Date(1, time.January, 1, 4, 5, 6, 123000000,
		time.FixedZone("", -7*60*60))},
	{"04:05:06-07", time.Date(1, time.January, 1, 4, 5, 6, 0,
		time.FixedZone("", -7*60*60))},
	{"04:05:06-07:42", time.Date(1, time.January, 1, 4, 5, 6, 0,
		time.FixedZone("", -7*60*60+42*60))},
	{"04:05:06-07:30:09", time.Date(1, time.January, 1, 4, 5, 6, 0,
		time.FixedZone("", -7*60*60+30*60+9))},
	{"04:05:06+07", time.Date(1, time.January, 1, 4, 5, 6, 0,
		time.FixedZone("", 7*60*60))},
}
